            ...
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3  p-2 shadow bg-base-100 rounded-box w-52">
                        <li ><Link to='/' className="hover:bg-white font-semibold text-base  hover:text-[#F379A7]">Home</Link></li>
                        ...
                        <li><Link to='/blog' className="hover:bg-white  font-semibold text-base hover:text-[#F379A7]">Blogs</Link></li>
                    </ul>
                </div>

                <Link><img className="w-44" src="logo.png" alt="" /></Link>
            </div>
